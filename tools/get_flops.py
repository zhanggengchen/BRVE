...
def main():
    ...
    with open(f'{config_name}.txt', 'w') as f:
        flops, params = get_model_complexity_info(model, input_shape, ost=f)
        split_line = '=' * 30
...
# CUDA_VISIBLE_DEVICES=3 python tools/get_flops.py configs/EMVDv4_llrvd.py --shape 100 4 960 544
# CUDA_VISIBLE_DEVICES=2 python tools/get_flops.py configs/ShiftNetv2_llrvd.py --shape 100 4 128 128